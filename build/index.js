...
function main(sources) {
  var ITEMS_URL = 'http://localhost:3000/items?itemid=';
  var getItems$ = sources.DOM.select('.get-random').events('click').map(function () {
    var randomNum = 534;
    return {
      url: ITEMS_URL + randomNum,
      method: 'GET'
    };
  });
  ...
  var vtree$ = user$.map(function (user) {
    return (0, _dom.div)('.users', [(0, _dom.button)('.get-random', 'Get random user'), user === null ? null : (0, _dom.div)('.user-details', [(0, _dom.h1)('.user-name', user.title), (0, _dom.h4)('.user-email', user.description)])]);
  });
...
},{"@cycle/core":4,"@cycle/dom":5,"@cycle/http":14}],4:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":7,"./render-dom":8,"./render-html":9,"./virtual-hyperscript":12,"./virtual-hyperscript-svg":11,"hyperscript-helpers":20}],6:[function(require,module,exports){
"use strict";
...
},{"rx":28}],8:[function(require,module,exports){
"use strict";
...
},{"./fromevent":6,"./transposition":10,"./virtual-hyperscript":12,"matches-selector":25,"rx":28,"vdom-parser":34,"virtual-dom/diff":41,"virtual-dom/patch":42}],9:[function(require,module,exports){
"use strict";
...
},{"./transposition":10,"rx":28,"vdom-to-html":38}],10:[function(require,module,exports){
"use strict";
...
},{"rx":28,"virtual-dom/vnode/vnode":61}],11:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
},{"rx":28,"superagent":33}],14:[function(require,module,exports){
"use strict";
...
},{"min-document":1}],20:[function(require,module,exports){
'use strict';
...
},{"sentence-case":29}],27:[function(require,module,exports){
...
},{"emitter":16,"reduce":27}],34:[function(require,module,exports){
...
},{"browser-split":15}],53:[function(require,module,exports){
'use strict';
